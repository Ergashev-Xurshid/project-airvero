    ...
    <div>
      <div className='px-[15px] lg:px-[100px] xl:px-[200px] py-[80px]'>
        ...
        <div className='flex flex-wrap lg:flex-nowrap justify-center lg:justify-between items-start gap-[30px]'>
          {offerCard.map((item) => (
            <div key={item.id} className='overflow-hidden min-h-[690px] flex flex-col w-full md:w-[45%] lg:w-[35%] bg-[#eee] border border-[#ddd] rounded-[10px]'>
              ...
              <div onClick={() => setIsOpen(true)} className='pb-[40px] text-center mt-auto'>
